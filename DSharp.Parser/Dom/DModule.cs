...
namespace D_Parser.Dom
{
    ...
    public class DModule : DBlockNode, IAbstractSyntaxTree
    {
		...
		public NamespaceStatement NamespaceOverride = null;
    ...
    public class DMethod : DNode,IBlockNode
    {
		...
		/// <summary>
		/// Returns true if method has @entrypoint attribute.
		/// If applied, this function will be the assembly's entry point.
		/// </summary>
		public bool IsEntryFunction
		{
			get {
				return ContainsPropertyAttribute("entrypoint");
			}
		}
    ...
    {
		public new bool IsAnonymous = false;
