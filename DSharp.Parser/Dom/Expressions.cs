...
namespace D_Parser.Dom.Expressions
{
	...
	public class IdentifierExpression : PrimaryExpression
	{
		...
		public override string ToString()
		{
			if(Format!=DSharp.Parser.LiteralFormat.None)
				switch (Format)
				{
					case DSharp.Parser.LiteralFormat.CharLiteral:
						return "'"+Value+"'";
					case DSharp.Parser.LiteralFormat.StringLiteral:
						return "\"" + Value + "\"";
					case DSharp.Parser.LiteralFormat.VerbatimStringLiteral:
						return "r\"" + Value + "\"";
				}
