...
namespace DSharp.Parser
{
    public class DTokens
    {
        ...
        public const int empty0 = 104;
        public const int Mixin = 105;
        public const int empty1 = 106;
        ...
        public const int Namespace = 156;
    ...
    {With,	"with"}
		...
		/// <summary>
		/// Operators which can be located in front of assign operators (see AssignOps)
		/// </summary>
